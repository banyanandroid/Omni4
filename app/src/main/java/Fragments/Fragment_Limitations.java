...
public class Fragment_Limitations extends Fragment {
    int fragVal;
    ...
    public static Fragment_Limitations init(int val) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        prev.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                fragmentTransaction.replace(R.id.limitations, fragment_curcumin);
