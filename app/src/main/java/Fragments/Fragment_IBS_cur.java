...
public class Fragment_IBS_cur extends Fragment {
    int fragVal;
    ImageView next, prev;
    ImageView center_bg, omni_bg;
    TextView strngth_bg;

    public static Fragment_IBS_cur init(int val) {
        Fragment_IBS_cur fragment_curcumin = new Fragment_IBS_cur();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Fragment_IBS_limi Fragment_IBS_limi = new Fragment_IBS_limi();
                FragmentManager fragmentManager = getFragmentManager();
                FragmentTransaction fragmentTransaction = fragmentManager.beginTransaction();
                fragmentTransaction.replace(R.id.curcumin, Fragment_IBS_limi);
                fragmentTransaction.addToBackStack(null);
                fragmentTransaction.commit();
