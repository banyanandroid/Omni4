...
public class Fragment_38 extends Fragment {
    int fragVal;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final View layoutView = inflater.inflate(R.layout.fragment_lay_38, container,
                false);
        ...
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                fragmentTransaction.replace(R.id.conk, fragment_39);
        ...
        prev.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                FragmentManager fragmentManager = getFragmentManager();
                FragmentTransaction fragmentTransaction = fragmentManager.beginTransaction();
                fragmentTransaction.replace(R.id.conk, fragment_37);
                fragmentTransaction.addToBackStack(null);
                fragmentTransaction.commit();
