...
import Fragments.Fragment_13;
import Fragments.Fragment_14;
import Fragments.Fragment_15;
import Fragments.Fragment_16;
import Fragments.Fragment_17;
import Fragments.Fragment_18;
...
public class Ibs_Activity extends FragmentActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ibs_);
        ...
        public Fragment getItem(int position) {
            switch (position) {
                ...
                case 1: // Fragment # 1 - This will show image
                    return Fragment_14.init(position);
                case 2: // Fragment # 2 - This will show image
                    return Fragment_15.init(position);
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_CurONC) {
            ...
            // Handle the Diabetes action
            Intent inm = new Intent(this,Video_Activity.class);
            startActivity(inm);
